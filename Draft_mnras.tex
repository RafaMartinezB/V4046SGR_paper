...
\begin{abstract}
    ...
    %aim
    We report on new $\sim$20\,mas resolution Atacama Large Millimeter Array (ALMA) observations of the radio continuum at 1.3\,mm, and compare with archival SPHERE-IRDIS differential polarised imaging (DPI) of scattered-light at H-band (1.65\,$\micron$) to reach conclusions on the disc structure. 
    %methods
